...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        String usersByUsername = "SELECT username, password, TRUE FROM basis.users WHERE username = ?";

        String authoritiesByUsernameQuery = "SELECT users.username,role FROM basis.user_roles as roles\n" +
                "LEFT JOIN basis.users as users ON (users.id = roles.user_id) WHERE users.username = ?";
